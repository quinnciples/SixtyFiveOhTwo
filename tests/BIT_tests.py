...
def BIT_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_OVERFLOW_FLAG_NO_NEGATIVE_FLAG() -> bool:
    TEST_NAME = f'BIT_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_OVERFLOW_FLAG_NO_NEGATIVE_FLAG'
    INSTRUCTION = 'BIT'
    VALUE_IN_MEMORY = 0x09  # Set this for loading an initial value into memory
...
def BIT_ADDRESS_MODE_TESTS_ZERO_FLAG_NO_OVERFLOW_FLAG_NO_NEGATIVE_FLAG() -> bool:
    TEST_NAME = f'BIT_ADDRESS_MODE_TESTS_ZERO_FLAG_NO_OVERFLOW_FLAG_NO_NEGATIVE_FLAG'
    INSTRUCTION = 'BIT'
...
def BIT_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_OVERFLOW_FLAG_NO_NEGATIVE_FLAG() -> bool:
    TEST_NAME = f'BIT_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_OVERFLOW_FLAG_NO_NEGATIVE_FLAG'
    INSTRUCTION = 'BIT'
    VALUE_IN_MEMORY = 0b01000000  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
    IND_ZP_ADDRESS = 0x72  # Set this for loading an initial value into memory
    FULL_ADDRESS = 0xABDC  # Set this for loading an initial value into memory
...
def BIT_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_OVERFLOW_FLAG_NEGATIVE_FLAG() -> bool:
    TEST_NAME = f'BIT_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_OVERFLOW_FLAG_NEGATIVE_FLAG'
    INSTRUCTION = 'BIT'
...
def BIT_tests():
    tests = [
        BIT_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_OVERFLOW_FLAG_NO_NEGATIVE_FLAG,
        BIT_ADDRESS_MODE_TESTS_ZERO_FLAG_NO_OVERFLOW_FLAG_NO_NEGATIVE_FLAG,
        BIT_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_OVERFLOW_FLAG_NO_NEGATIVE_FLAG,
        BIT_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_OVERFLOW_FLAG_NEGATIVE_FLAG,
    ]
    results = []
    for test in tests:
        results.append(test())
