...
def TEST_0x2A_ROL_ACC_MODE_TESTS():
    TEST_NAME = f'TEST_0x2A_ROL_ACC_MODE_TESTS'
    INSTRUCTION = 'ROL'
    ...
    EXPECTED_VALUE = 0b00000010  # Set this when a value should be written to memory
    CYCLE_COUNTS = {
        'ACC': 2
    }
    INITIAL_REGISTERS = {
...
def TEST_0x2A_ROL_ACC_MODE_TESTS_SETS_CARRY_FLAG():
    TEST_NAME = f'TEST_0x2A_ROL_ACC_MODE_TESTS_SETS_CARRY_FLAG'
    INSTRUCTION = 'ROL'
...
def TEST_0x2A_ROL_ACC_MODE_TESTS_SETS_ZERO_FLAG():
    TEST_NAME = f'TEST_0x2A_ROL_ACC_MODE_TESTS_SETS_ZERO_FLAG'
    INSTRUCTION = 'ROL'
...
def TEST_0x2A_ROL_ACC_MODE_TESTS_CARRY_FLAG_ROLLS_OVER_TO_BIT_0():
    TEST_NAME = f'TEST_0x2A_ROL_ACC_MODE_TESTS_CARRY_FLAG_ROLLS_OVER_TO_BIT_0'
    INSTRUCTION = 'ROL'
    VALUE_IN_MEMORY = 0b00000001  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
    IND_ZP_ADDRESS = 0x72  # Set this for loading an initial value into memory
    FULL_ADDRESS = 0xABDC  # Set this for loading an initial value into memory
    EXPECTED_VALUE = 0b00000011  # Set this when a value should be written to memory
    CYCLE_COUNTS = {
        'ACC': 2
    }
    INITIAL_REGISTERS = {
...
def TEST_0x2A_ROL_ADDRESS_MODE_TESTS_SETS_CARRY_FLAG():
    TEST_NAME = f'TEST_0x2A_ROL_ADDRESS_MODE_TESTS_SETS_CARRY_FLAG'
    INSTRUCTION = 'ROL'
    VALUE_IN_MEMORY = 0b10000001  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
...
def TEST_0x2A_ROL_ADDRESS_MODE_TESTS_SETS_ZERO_FLAG():
    TEST_NAME = f'TEST_0x2A_ROL_ADDRESS_MODE_TESTS_SETS_ZERO_FLAG'
    INSTRUCTION = 'ROL'
    VALUE_IN_MEMORY = 0b00000000  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
...
def TEST_0x2A_ROL_ADDRESS_MODE_TESTS_CARRY_FLAG_ROLLS_OVER_TO_BIT_0():
    TEST_NAME = f'TEST_0x2A_ROL_ADDRESS_MODE_TESTS_CARRY_FLAG_ROLLS_OVER_TO_BIT_0'
    INSTRUCTION = 'ROL'
    VALUE_IN_MEMORY = 0b00000001  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
...
def ROL_tests():
    tests = [
        TEST_0x2A_ROL_ACC_MODE_TESTS,
        TEST_0x2A_ROL_ACC_MODE_TESTS_SETS_CARRY_FLAG,
        TEST_0x2A_ROL_ACC_MODE_TESTS_SETS_ZERO_FLAG,
        TEST_0x2A_ROL_ACC_MODE_TESTS_CARRY_FLAG_ROLLS_OVER_TO_BIT_0,
        TEST_0x2A_ROL_ADDRESS_MODE_TESTS,
        TEST_0x2A_ROL_ADDRESS_MODE_TESTS_SETS_CARRY_FLAG,
        TEST_0x2A_ROL_ADDRESS_MODE_TESTS_SETS_ZERO_FLAG,
        TEST_0x2A_ROL_ADDRESS_MODE_TESTS_CARRY_FLAG_ROLLS_OVER_TO_BIT_0,
    ]
    results = []
    for test in tests:
        results.append(test())
