...
def ORA_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED() -> bool:
    TEST_NAME = f'ORA_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED'
    INSTRUCTION = 'ORA'
    VALUE_TO_TEST = 0x44
...
def ORA_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED() -> bool:
    TEST_NAME = f'ORA_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED'
    INSTRUCTION = 'ORA'
    VALUE_TO_TEST = 0x00
    IMMEDIATE_VALUE = VALUE_TO_TEST
    ZP_ADDRESS = 0x0059
...
def ORA_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_PAGE_BOUNDARY_CROSSED() -> bool:
    TEST_NAME = f'ORA_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_PAGE_BOUNDARY_CROSSED'
    INSTRUCTION = 'ORA'
    VALUE_TO_TEST = 0xF0
    IMMEDIATE_VALUE = VALUE_TO_TEST
    ZP_ADDRESS = 0x0059
...
def ORA_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_PAGE_BOUNDARY_CROSSED() -> bool:
    TEST_NAME = f'ORA_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_PAGE_BOUNDARY_CROSSED'
    INSTRUCTION = 'ORA'
    VALUE_TO_TEST = 0x44
    IMMEDIATE_VALUE = VALUE_TO_TEST
    ZP_ADDRESS = 0x0059
...
def ORA_tests():
    tests = [
        ORA_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED,
        ORA_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED,
        ORA_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_PAGE_BOUNDARY_CROSSED,
        # ORA_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_PAGE_BOUNDARY_CROSSED
    ]
    results = []
    for test in tests:
        results.append(test())
