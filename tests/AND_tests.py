...
def AND_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED() -> bool:
    TEST_NAME = f'AND_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED'
    INSTRUCTION = 'AND'
    VALUE_TO_TEST = 0x62
...
def AND_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED() -> bool:
    TEST_NAME = f'AND_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED'
    INSTRUCTION = 'AND'
    VALUE_TO_TEST = 0x7F
    IMMEDIATE_VALUE = VALUE_TO_TEST
    ZP_ADDRESS = 0x0059
...
def AND_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_PAGE_BOUNDARY_CROSSED() -> bool:
    TEST_NAME = f'AND_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_PAGE_BOUNDARY_CROSSED'
    INSTRUCTION = 'AND'
    VALUE_TO_TEST = 0xAF
    IMMEDIATE_VALUE = VALUE_TO_TEST
    ZP_ADDRESS = 0x0059
...
def AND_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_PAGE_BOUNDARY_CROSSED() -> bool:
    TEST_NAME = f'AND_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_PAGE_BOUNDARY_CROSSED'
    INSTRUCTION = 'AND'
    VALUE_TO_TEST = 0x62
    IMMEDIATE_VALUE = VALUE_TO_TEST
    ZP_ADDRESS = 0x0059
...
def AND_tests():
    tests = [
        AND_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED,
        AND_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED,
        AND_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_PAGE_BOUNDARY_CROSSED,
        AND_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_PAGE_BOUNDARY_CROSSED
    ]
    results = []
    for test in tests:
        results.append(test())
