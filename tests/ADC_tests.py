...
def TEST_0x2A_ADC_ACC_MODE_TESTS():
    TEST_NAME = f'TEST_0x2A_ADC_ACC_MODE_TESTS'
    INSTRUCTION = 'ADC'
...
def TEST_0x2A_ADC_ACC_MODE_TESTS_WRAPAROUND_CARRY_FLAG_SET_ZERO_FLAG_SET():
    TEST_NAME = f'TEST_0x2A_ADC_ACC_MODE_TESTS_WRAPAROUND_CARRY_FLAG_SET_ZERO_FLAG_SET'
    INSTRUCTION = 'ADC'
    VALUE_IN_MEMORY = 0x01  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = 0x01  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
...
def TEST_0x2A_ADC_ACC_MODE_TESTS_NO_WRAPAROUND_CARRY_FLAG_NOT_SET_ZERO_FLAG_SET():
    TEST_NAME = f'TEST_0x2A_ADC_ACC_MODE_TESTS_NO_WRAPAROUND_CARRY_FLAG_NOT_SET_ZERO_FLAG_SET'
    INSTRUCTION = 'ADC'
    VALUE_IN_MEMORY = 0x00  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = 0x00  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
    IND_ZP_ADDRESS = 0x72  # Set this for loading an initial value into memory
    FULL_ADDRESS = 0xABDC  # Set this for loading an initial value into memory
    EXPECTED_VALUE = None  # Set this when a value should be written to memory
...
def TEST_0x2A_ADC_ACC_MODE_TESTS_NO_WRAPAROUND_CARRY_FLAG_NOT_SET_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_SET_OVERFLOW_FLAG_SET():
    TEST_NAME = f'TEST_0x2A_ADC_ACC_MODE_TESTS_NO_WRAPAROUND_CARRY_FLAG_NOT_SET_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_SET_OVERFLOW_FLAG_SET'
    INSTRUCTION = 'ADC'
    VALUE_IN_MEMORY = 0b00000001  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = 0b00000001  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
    IND_ZP_ADDRESS = 0x72  # Set this for loading an initial value into memory
    FULL_ADDRESS = 0xABDC  # Set this for loading an initial value into memory
    EXPECTED_VALUE = None  # Set this when a value should be written to memory
...
def TEST_0x2A_ADC_ACC_MODE_TESTS_WRAPAROUND_CARRY_FLAG_SET_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_SET():
    TEST_NAME = f'TEST_0x2A_ADC_ACC_MODE_TESTS_WRAPAROUND_CARRY_FLAG_SET_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_SET'
    INSTRUCTION = 'ADC'
...
def ADC_tests():
    tests = [
        TEST_0x2A_ADC_ACC_MODE_TESTS,
        TEST_0x2A_ADC_ACC_MODE_TESTS_WRAPAROUND_CARRY_FLAG_SET_ZERO_FLAG_SET,
        TEST_0x2A_ADC_ACC_MODE_TESTS_NO_WRAPAROUND_CARRY_FLAG_NOT_SET_ZERO_FLAG_SET,
        TEST_0x2A_ADC_ACC_MODE_TESTS_NO_WRAPAROUND_CARRY_FLAG_NOT_SET_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_SET_OVERFLOW_FLAG_SET,
        TEST_0x2A_ADC_ACC_MODE_TESTS_WRAPAROUND_CARRY_FLAG_SET_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_SET,
    ]
    results = []
    for test in tests:
        results.append(test())
