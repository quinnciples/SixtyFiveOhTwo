...
def TEST_ADC_ACC_MODE_TESTS():
    TEST_NAME = f'TEST_ADC_ACC_MODE_TESTS'
    INSTRUCTION = 'ADC'
...
def TEST_ADC_ACC_MODE_TESTS_WRAPAROUND_CARRY_FLAG_SET_ZERO_FLAG_SET():
    TEST_NAME = f'TEST_ADC_ACC_MODE_TESTS_WRAPAROUND_CARRY_FLAG_SET_ZERO_FLAG_SET'
    INSTRUCTION = 'ADC'
    VALUE_IN_MEMORY = 0x01  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = 0x01  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
...
def TEST_ADC_ACC_MODE_TESTS_NO_WRAPAROUND_CARRY_FLAG_NOT_SET_ZERO_FLAG_SET():
    TEST_NAME = f'TEST_ADC_ACC_MODE_TESTS_NO_WRAPAROUND_CARRY_FLAG_NOT_SET_ZERO_FLAG_SET'
    INSTRUCTION = 'ADC'
...
def TEST_ADC_ACC_MODE_TESTS_NO_WRAPAROUND_CARRY_FLAG_NOT_SET_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_SET_OVERFLOW_FLAG_SET():
    TEST_NAME = f'TEST_ADC_ACC_MODE_TESTS_NO_WRAPAROUND_CARRY_FLAG_NOT_SET_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_SET_OVERFLOW_FLAG_SET'
    INSTRUCTION = 'ADC'
...
def TEST_ADC_ACC_MODE_TESTS_WRAPAROUND_CARRY_FLAG_SET_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_SET():
    TEST_NAME = f'TEST_ADC_ACC_MODE_TESTS_WRAPAROUND_CARRY_FLAG_SET_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_SET'
    INSTRUCTION = 'ADC'
...
def ADC_tests():
    tests = [
        TEST_ADC_ACC_MODE_TESTS,
        TEST_ADC_ACC_MODE_TESTS_WRAPAROUND_CARRY_FLAG_SET_ZERO_FLAG_SET,
        TEST_ADC_ACC_MODE_TESTS_NO_WRAPAROUND_CARRY_FLAG_NOT_SET_ZERO_FLAG_SET,
        TEST_ADC_ACC_MODE_TESTS_NO_WRAPAROUND_CARRY_FLAG_NOT_SET_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_SET_OVERFLOW_FLAG_SET,
        TEST_ADC_ACC_MODE_TESTS_WRAPAROUND_CARRY_FLAG_SET_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_SET,
    ]
    results = []
    for test in tests:
        results.append(test())
