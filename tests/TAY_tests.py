...
def TEST_0xA8_TAY_TESTS():
    TEST_NAME = f'TEST_0xA8_TAY_TESTS'
    INSTRUCTION = 'TAY'
...
def TEST_0xA8_TAY_TESTS_ZERO_FLAG_TEST():
    TEST_NAME = f'TEST_0xA8_TAY_TESTS'
    INSTRUCTION = 'TAY'
    VALUE_IN_MEMORY = None  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
...
def TEST_0xA8_TAY_TESTS_NEGATIVE_FLAG_TEST():
    TEST_NAME = f'TEST_0xA8_TAY_TESTS'
    INSTRUCTION = 'TAY'
    VALUE_IN_MEMORY = None  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
...
def TAY_tests():
    tests = [
        TEST_0xA8_TAY_TESTS,
        TEST_0xA8_TAY_TESTS_ZERO_FLAG_TEST,
        TEST_0xA8_TAY_TESTS_NEGATIVE_FLAG_TEST,
    ]
    results = []
    for test in tests:
        results.append(test())
