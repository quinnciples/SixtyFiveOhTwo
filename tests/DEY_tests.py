...
def DEY_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_WRAPAROUND() -> bool:
    TEST_NAME = f'DEY_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_WRAPAROUND'
    INSTRUCTION = 'DEY'
...
def DEY_ADDRESS_MODE_TESTS_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_WITH_WRAPAROUND() -> bool:
    TEST_NAME = f'DEY_ADDRESS_MODE_TESTS_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_WITH_WRAPAROUND'
    INSTRUCTION = 'DEY'
    VALUE_IN_MEMORY = None
    IMMEDIATE_VALUE = None
    ZP_ADDRESS = None
...
def DEY_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NEGATIVE_FLAG_NOT_SET_NO_WRAPAROUND() -> bool:
    TEST_NAME = f'DEY_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NEGATIVE_FLAG_NOT_SET_NO_WRAPAROUND'
    INSTRUCTION = 'DEY'
    VALUE_IN_MEMORY = None
    IMMEDIATE_VALUE = None
    ZP_ADDRESS = None
...
def DEY_tests():
    tests = [
        DEY_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_WRAPAROUND,
        DEY_ADDRESS_MODE_TESTS_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_WITH_WRAPAROUND,
        DEY_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NEGATIVE_FLAG_NOT_SET_NO_WRAPAROUND,
    ]
    results = []
    for test in tests:
        results.append(test())
