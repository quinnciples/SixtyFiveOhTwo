...
def TEST_0x10_BPL_DOES_NOT_BRANCH():
    TEST_NAME = 'TEST_0x10_BPL_DOES_NOT_BRANCH'
    EXPECTED_CYCLES = 2
    INITIAL_REGISTERS = {
        'A': 0x7F,
        'X': 0xDD,
...
def TEST_0x10_BPL_SUCCESSFUL_BRANCH():
    TEST_NAME = 'TEST_0x10_BPL_SUCCESSFUL_BRANCH'
    EXPECTED_CYCLES = 3 + 2
    INITIAL_REGISTERS = {
        'A': 0x7F,
        'X': 0xDD,
...
def TEST_0x10_BPL_SUCCESSFUL_BRANCH_CROSS_PAGE_BOUNDARY():
    TEST_NAME = 'TEST_0x10_BPL_SUCCESSFUL_BRANCH_CROSS_PAGE_BOUNDARY'
    EXPECTED_CYCLES = 4 + 2
    INITIAL_REGISTERS = {
        'A': 0x7F,
        'X': 0xDD,
    ...
    program = [0x10, 0x04, 0x00, 0x00, 0x00, 0x00, 0xA9, 0x15]
