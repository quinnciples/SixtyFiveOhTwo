...
def INC_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_WRAPAROUND() -> bool:
    TEST_NAME = f'INC_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_WRAPAROUND'
    INSTRUCTION = 'INC'
    VALUE_IN_MEMORY = 0x05
...
def INC_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_WRAPAROUND() -> bool:
    TEST_NAME = f'INC_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_WRAPAROUND'
    INSTRUCTION = 'INC'
    VALUE_IN_MEMORY = 0xFF
    IMMEDIATE_VALUE = None
    ZP_ADDRESS = 0x69
    IND_ZP_ADDRESS = 0x79
    FULL_ADDRESS = 0xADCB
...
def INC_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_WRAPAROUND() -> bool:
    TEST_NAME = f'INC_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_WRAPAROUND'
    INSTRUCTION = 'INC'
    VALUE_IN_MEMORY = 0xFD
    IMMEDIATE_VALUE = None
    ZP_ADDRESS = 0x69
    IND_ZP_ADDRESS = 0x79
    FULL_ADDRESS = 0xADCB
...
def INC_tests():
    tests = [
        INC_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_WRAPAROUND,
        INC_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_WRAPAROUND,
        INC_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_WRAPAROUND,
    ]
    results = []
    for test in tests:
        results.append(test())
