...
def TEST_0xEA_LSR_ADDRESS_MODE_TESTS():
    TEST_NAME = f'TEST_0xEA_LSR_ADDRESS_MODE_TESTS'
    INSTRUCTION = 'LSR'
    VALUE_IN_MEMORY = 0x02  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
...
def TEST_0xEA_LSR_ADDRESS_MODE_TESTS_ZERO_FLAG_SET():
    TEST_NAME = f'TEST_0xEA_LSR_ADDRESS_MODE_TESTS_ZERO_FLAG_SET'
    INSTRUCTION = 'LSR'
...
def TEST_0xEA_LSR_ADDRESS_MODE_TESTS_CARRY_FLAG_SET():
    TEST_NAME = f'TEST_0xEA_LSR_ADDRESS_MODE_TESTS_CARRY_FLAG_SET'
    INSTRUCTION = 'LSR'
...
def LSR_tests():
    tests = [
        TEST_0xEA_LSR_ACC_MODE_TESTS,
        TEST_0xEA_LSR_ADDRESS_MODE_TESTS,
        TEST_0xEA_LSR_ADDRESS_MODE_TESTS_ZERO_FLAG_SET,
        TEST_0xEA_LSR_ADDRESS_MODE_TESTS_CARRY_FLAG_SET,
    ]
    results = []
    for test in tests:
        results.append(test())
