...
def TEST_0x2A_TAX_TESTS():
    TEST_NAME = f'TEST_0x2A_TAX_TESTS'
    INSTRUCTION = 'TAX'
...
def TEST_0x2A_TAX_TESTS_ZERO_FLAG_TEST():
    TEST_NAME = f'TEST_0x2A_TAX_TESTS'
    INSTRUCTION = 'TAX'
    VALUE_IN_MEMORY = None  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
...
def TEST_0x2A_TAX_TESTS_NEGATIVE_FLAG_TEST():
    TEST_NAME = f'TEST_0x2A_TAX_TESTS'
    INSTRUCTION = 'TAX'
    VALUE_IN_MEMORY = None  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
...
def TAX_tests():
    tests = [
        TEST_0x2A_TAX_TESTS,
        TEST_0x2A_TAX_TESTS_ZERO_FLAG_TEST,
        TEST_0x2A_TAX_TESTS_NEGATIVE_FLAG_TEST,
    ]
    results = []
    for test in tests:
        results.append(test())
