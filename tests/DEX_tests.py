...
def DEX_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_WRAPAROUND() -> bool:
    TEST_NAME = f'DEX_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_WRAPAROUND'
    INSTRUCTION = 'DEX'
...
def DEX_ADDRESS_MODE_TESTS_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_WITH_WRAPAROUND() -> bool:
    TEST_NAME = f'DEX_ADDRESS_MODE_TESTS_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_WITH_WRAPAROUND'
    INSTRUCTION = 'DEX'
    VALUE_IN_MEMORY = None
    IMMEDIATE_VALUE = None
    ZP_ADDRESS = None
...
def DEX_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NEGATIVE_FLAG_NOT_SET_NO_WRAPAROUND() -> bool:
    TEST_NAME = f'DEX_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NEGATIVE_FLAG_NOT_SET_NO_WRAPAROUND'
    INSTRUCTION = 'DEX'
    VALUE_IN_MEMORY = None
    IMMEDIATE_VALUE = None
    ZP_ADDRESS = None
...
def DEX_tests():
    tests = [
        DEX_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_WRAPAROUND,
        DEX_ADDRESS_MODE_TESTS_ZERO_FLAG_NOT_SET_NEGATIVE_FLAG_WITH_WRAPAROUND,
        DEX_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NEGATIVE_FLAG_NOT_SET_NO_WRAPAROUND,
    ]
    results = []
    for test in tests:
        results.append(test())
