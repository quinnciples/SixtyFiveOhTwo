...
def LDX_ADDRESS_MODE_TESTS_NON_ZERO_NON_NEGATIVE_NO_PAGE_CROSSED() -> bool:
    TEST_NAME = f'LDX_ADDRESS_MODE_TESTS_NON_ZERO_NON_NEGATIVE_NO_PAGE_CROSSED'
    INSTRUCTION = 'LDX'
    ...
    CYCLE_COUNTS = {'IM': 2, 'ZP': 3, 'ZP_Y': 4, 'ABS': 4, 'ABS_Y': 4}
    INITIAL_REGISTERS = {
        'A': 0xFF,
        'X': 0x01,
        'Y': 0x05
...
def LDX_ADDRESS_MODE_TESTS_ZERO_FLAG_NON_NEGATIVE_NO_PAGE_CROSSED() -> bool:
    TEST_NAME = f'LDX_ADDRESS_MODE_TESTS_ZERO_FLAG_NON_NEGATIVE_NO_PAGE_CROSSED'
    INSTRUCTION = 'LDX'
...
def LDX_ADDRESS_MODE_TESTS_NON_ZERO_NEGATIVE_FLAG_NO_PAGE_CROSSED() -> bool:
    TEST_NAME = f'LDX_ADDRESS_MODE_TESTS_NON_ZERO_NEGATIVE_FLAG_NO_PAGE_CROSSED'
    INSTRUCTION = 'LDX'
...
def LDX_ADDRESS_MODE_TESTS_NON_ZERO_NON_NEGATIVE_PAGE_CROSSED() -> bool:
    TEST_NAME = f'LDX_ADDRESS_MODE_TESTS_NON_ZERO_NON_NEGATIVE_PAGE_CROSSED'
    INSTRUCTION = 'LDX'
    ...
    VALUE_TO_TEST = IMMEDIATE_VALUE
    EXPECTED_VALUE = IMMEDIATE_VALUE
    CYCLE_COUNTS = {'IM': 2, 'ZP': 3, 'ZP_Y': 4, 'ABS': 4, 'ABS_Y': 5}
    INITIAL_REGISTERS = {
        'A': 0xFF,
        'X': 0xFF,
        'Y': 0xFF
...
def LDX_tests():
    tests = [
        LDX_ADDRESS_MODE_TESTS_NON_ZERO_NON_NEGATIVE_NO_PAGE_CROSSED,
        LDX_ADDRESS_MODE_TESTS_ZERO_FLAG_NON_NEGATIVE_NO_PAGE_CROSSED,
        LDX_ADDRESS_MODE_TESTS_NON_ZERO_NEGATIVE_FLAG_NO_PAGE_CROSSED,
        LDX_ADDRESS_MODE_TESTS_NON_ZERO_NON_NEGATIVE_PAGE_CROSSED,
    ]
    results = []
    for test in tests:
        results.append(test())
