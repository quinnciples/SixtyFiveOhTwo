...
def TEST_0x2A_ASL_ACC_MODE_TESTS():
    TEST_NAME = f'TEST_0x2A_ASL_ACC_MODE_TESTS'
    INSTRUCTION = 'ASL'
    ...
    EXPECTED_VALUE = 0x02  # Set this when a value should be written to memory
    CYCLE_COUNTS = {
        'ACC': 2
    }
    INITIAL_REGISTERS = {
...
def TEST_0x2A_ASL_ADDRESS_MODE_TESTS():
    TEST_NAME = f'TEST_0x2A_ASL_ADDRESS_MODE_TESTS'
    INSTRUCTION = 'ASL'
    VALUE_IN_MEMORY = 0x01  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
...
def TEST_0x2A_ASL_ADDRESS_MODE_TESTS_ZERO_FLAG_SET():
    TEST_NAME = f'TEST_0x2A_ASL_ADDRESS_MODE_TESTS_ZERO_FLAG_SET'
    INSTRUCTION = 'ASL'
    ...
    IND_ZP_ADDRESS = 0x72  # Set this for loading an initial value into memory
    FULL_ADDRESS = 0xABDC  # Set this for loading an initial value into memory
    EXPECTED_VALUE = 0x00  # Set this when a value should be written to memory
    CYCLE_COUNTS = {
        'ZP': 5,
        'ZP_X': 6,
        'ABS': 6,
...
def TEST_0x2A_ASL_ADDRESS_MODE_TESTS_CARRY_FLAG_SET():
    TEST_NAME = f'TEST_0x2A_ASL_ADDRESS_MODE_TESTS_CARRY_FLAG_SET'
    INSTRUCTION = 'ASL'
...
def TEST_0x2A_ASL_ADDRESS_MODE_TESTS_NEGATIVE_FLAG_SET():
    TEST_NAME = f'TEST_0x2A_ASL_ADDRESS_MODE_TESTS_NEGATIVE_FLAG_SET'
    INSTRUCTION = 'ASL'
    VALUE_IN_MEMORY = 0b01000001  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
    IND_ZP_ADDRESS = 0x72  # Set this for loading an initial value into memory
    FULL_ADDRESS = 0xABDC  # Set this for loading an initial value into memory
    EXPECTED_VALUE = 0b10000010  # Set this when a value should be written to memory
    CYCLE_COUNTS = {
        'ZP': 5,
        'ZP_X': 6,
        'ABS': 6,
...
def ASL_tests():
    tests = [
        TEST_0x2A_ASL_ACC_MODE_TESTS,
        TEST_0x2A_ASL_ADDRESS_MODE_TESTS,
        TEST_0x2A_ASL_ADDRESS_MODE_TESTS_ZERO_FLAG_SET,
