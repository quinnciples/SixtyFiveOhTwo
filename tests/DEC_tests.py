...
def DEC_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_WRAPAROUND() -> bool:
    TEST_NAME = f'DEC_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_WRAPAROUND'
    INSTRUCTION = 'DEC'
...
def DEC_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_NO_WRAPAROUND() -> bool:
    TEST_NAME = f'DEC_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_NO_WRAPAROUND'
    INSTRUCTION = 'DEC'
    VALUE_IN_MEMORY = 0x01
    IMMEDIATE_VALUE = None
    ZP_ADDRESS = 0x69
    IND_ZP_ADDRESS = 0x79
    FULL_ADDRESS = 0xADCB
...
def DEC_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_WRAPAROUND() -> bool:
    TEST_NAME = f'DEC_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_WRAPAROUND'
    INSTRUCTION = 'DEC'
    VALUE_IN_MEMORY = 0x00
    IMMEDIATE_VALUE = None
    ZP_ADDRESS = 0x69
    IND_ZP_ADDRESS = 0x79
    FULL_ADDRESS = 0xADCB
...
def DEC_tests():
    tests = [
        DEC_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_WRAPAROUND,
        DEC_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_NO_WRAPAROUND,
        DEC_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_WRAPAROUND,
    ]
    results = []
    for test in tests:
        results.append(test())
