...
def DEC_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_WRAPAROUND() -> bool:
    TEST_NAME = f'DEC_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_WRAPAROUND'
    INSTRUCTION = 'DEC'
...
def DEC_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_WRAPAROUND() -> bool:
    TEST_NAME = f'DEC_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_WRAPAROUND'
    INSTRUCTION = 'DEC'
...
def DEC_tests():
    tests = [
        ...
        DEC_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_WRAPAROUND,
        DEC_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_WRAPAROUND,
    ]
    results = []
    for test in tests:
        results.append(test())
