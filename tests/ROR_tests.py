...
def TEST_0x2A_ROR_ACC_MODE_TESTS():
    TEST_NAME = f'TEST_0x2A_ROR_ACC_MODE_TESTS'
    INSTRUCTION = 'ROR'
    VALUE_IN_MEMORY = 0b10000000  # Set this for loading an initial value into memory
    ...
    EXPECTED_VALUE = 0b01000000  # Set this when a value should be written to memory
    CYCLE_COUNTS = {
        'ACC': 2
    }
    INITIAL_REGISTERS = {
...
def TEST_0x2A_ROR_ACC_MODE_TESTS_SETS_CARRY_FLAG():
    TEST_NAME = f'TEST_0x2A_ROR_ACC_MODE_TESTS_SETS_CARRY_FLAG'
    INSTRUCTION = 'ROR'
    VALUE_IN_MEMORY = 0b10000001  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
    IND_ZP_ADDRESS = 0x72  # Set this for loading an initial value into memory
    FULL_ADDRESS = 0xABDC  # Set this for loading an initial value into memory
...
def TEST_0x2A_ROR_ACC_MODE_TESTS_SETS_ZERO_FLAG():
    TEST_NAME = f'TEST_0x2A_ROR_ACC_MODE_TESTS_SETS_ZERO_FLAG'
    INSTRUCTION = 'ROR'
    VALUE_IN_MEMORY = 0b00000000  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
    IND_ZP_ADDRESS = 0x72  # Set this for loading an initial value into memory
    FULL_ADDRESS = 0xABDC  # Set this for loading an initial value into memory
    EXPECTED_VALUE = 0b00000000  # Set this when a value should be written to memory
    CYCLE_COUNTS = {
        'ACC': 2
    }
    INITIAL_REGISTERS = {
...
def TEST_0x2A_ROR_ACC_MODE_TESTS_CARRY_FLAG_ROLLS_OVER_TO_BIT_7():
    TEST_NAME = f'TEST_0x2A_ROR_ACC_MODE_TESTS_CARRY_FLAG_ROLLS_OVER_TO_BIT_7'
    INSTRUCTION = 'ROR'
    VALUE_IN_MEMORY = 0b00000010  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
    IND_ZP_ADDRESS = 0x72  # Set this for loading an initial value into memory
    FULL_ADDRESS = 0xABDC  # Set this for loading an initial value into memory
    EXPECTED_VALUE = 0b10000001  # Set this when a value should be written to memory
    CYCLE_COUNTS = {
        'ACC': 2
    }
    INITIAL_REGISTERS = {
...
def TEST_0x2A_ROR_ADDRESS_MODE_TESTS():
    TEST_NAME = f'TEST_0x2A_ROR_ADDRESS_MODE_TESTS'
    INSTRUCTION = 'ROR'
    VALUE_IN_MEMORY = 0b01010000  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
    IND_ZP_ADDRESS = 0x72  # Set this for loading an initial value into memory
    FULL_ADDRESS = 0xABDC  # Set this for loading an initial value into memory
    EXPECTED_VALUE = 0b00101000  # Set this when a value should be written to memory
    CYCLE_COUNTS = {
        'ZP': 5,
        'ZP_X': 6,
        'ABS': 6,
...
def TEST_0x2A_ROR_ADDRESS_MODE_TESTS_SETS_CARRY_FLAG():
    TEST_NAME = f'TEST_0x2A_ROR_ADDRESS_MODE_TESTS_SETS_CARRY_FLAG'
    INSTRUCTION = 'ROR'
    VALUE_IN_MEMORY = 0b10000001  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
...
def TEST_0x2A_ROR_ADDRESS_MODE_TESTS_SETS_ZERO_FLAG():
    TEST_NAME = f'TEST_0x2A_ROR_ADDRESS_MODE_TESTS_SETS_ZERO_FLAG'
    INSTRUCTION = 'ROR'
    VALUE_IN_MEMORY = 0b00000000  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
...
def TEST_0x2A_ROR_ADDRESS_MODE_TESTS_CARRY_FLAG_ROLLS_OVER_TO_BIT_7():
    TEST_NAME = f'TEST_0x2A_ROR_ADDRESS_MODE_TESTS_CARRY_FLAG_ROLLS_OVER_TO_BIT_7'
    INSTRUCTION = 'ROR'
    VALUE_IN_MEMORY = 0b00000010  # Set this for loading an initial value into memory
    IMMEDIATE_VALUE = None  # Set this for loading an initial value into memory
    ZP_ADDRESS = 0x62  # Set this for loading an initial value into memory
...
def ROR_tests():
    tests = [
        TEST_0x2A_ROR_ACC_MODE_TESTS,
        TEST_0x2A_ROR_ACC_MODE_TESTS_SETS_CARRY_FLAG,
        TEST_0x2A_ROR_ACC_MODE_TESTS_SETS_ZERO_FLAG,
        TEST_0x2A_ROR_ACC_MODE_TESTS_CARRY_FLAG_ROLLS_OVER_TO_BIT_7,
        TEST_0x2A_ROR_ADDRESS_MODE_TESTS,
        TEST_0x2A_ROR_ADDRESS_MODE_TESTS_SETS_CARRY_FLAG,
        TEST_0x2A_ROR_ADDRESS_MODE_TESTS_SETS_ZERO_FLAG,
        TEST_0x2A_ROR_ADDRESS_MODE_TESTS_CARRY_FLAG_ROLLS_OVER_TO_BIT_7,
    ]
    results = []
    for test in tests:
        results.append(test())
