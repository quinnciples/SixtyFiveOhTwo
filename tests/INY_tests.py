...
def INY_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_WRAPAROUND() -> bool:
    TEST_NAME = f'INY_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_WRAPAROUND'
    INSTRUCTION = 'INY'
...
def INY_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_WITH_WRAPAROUND() -> bool:
    TEST_NAME = f'INY_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_WITH_WRAPAROUND'
    INSTRUCTION = 'INY'
    VALUE_IN_MEMORY = None
    IMMEDIATE_VALUE = None
    ZP_ADDRESS = None
...
def INY_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_WRAPAROUND() -> bool:
    TEST_NAME = f'INY_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_WRAPAROUND'
    INSTRUCTION = 'INY'
    VALUE_IN_MEMORY = None
    IMMEDIATE_VALUE = None
    ZP_ADDRESS = None
...
def INY_tests():
    tests = [
        INY_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_WRAPAROUND,
        INY_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_WITH_WRAPAROUND,
        INY_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_WRAPAROUND,
    ]
    results = []
    for test in tests:
        results.append(test())
