...
def EOR_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED() -> bool:
    TEST_NAME = f'EOR_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED'
    INSTRUCTION = 'EOR'
    VALUE_TO_TEST = 0xA6
...
def EOR_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED() -> bool:
    TEST_NAME = f'EOR_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED'
    INSTRUCTION = 'EOR'
    VALUE_TO_TEST = 0x7F
    IMMEDIATE_VALUE = VALUE_TO_TEST
    ZP_ADDRESS = 0x0059
...
def EOR_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_PAGE_BOUNDARY_CROSSED() -> bool:
    TEST_NAME = f'EOR_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_PAGE_BOUNDARY_CROSSED'
    INSTRUCTION = 'EOR'
    VALUE_TO_TEST = 0x23
    IMMEDIATE_VALUE = VALUE_TO_TEST
    ZP_ADDRESS = 0x0059
...
def EOR_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_PAGE_BOUNDARY_CROSSED() -> bool:
    TEST_NAME = f'EOR_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_PAGE_BOUNDARY_CROSSED'
    INSTRUCTION = 'EOR'
    VALUE_TO_TEST = 0xA6
    IMMEDIATE_VALUE = VALUE_TO_TEST
    ZP_ADDRESS = 0x0059
...
def EOR_tests():
    tests = [
        EOR_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED,
        EOR_ADDRESS_MODE_TESTS_ZERO_FLAG_SET_NO_NEGATIVE_FLAG_NO_PAGE_BOUNDARY_CROSSED,
        EOR_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NEGATIVE_FLAG_SET_NO_PAGE_BOUNDARY_CROSSED,
        EOR_ADDRESS_MODE_TESTS_NO_ZERO_FLAG_NO_NEGATIVE_FLAG_PAGE_BOUNDARY_CROSSED
    ]
    results = []
    for test in tests:
        results.append(test())
